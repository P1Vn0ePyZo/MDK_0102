...
public class BankAccountTest {
    ...
    void setUp() {
        ...
        account = new BankAccont("Иван Петров", 1000.0);
    ...
    void testDeposit() {
        ...
        Assertions.assertEquals(balanceBefore + 500.0, account.getBalance(), 0.001);
    ...
    void testWithdrawSuccess() {
        ...
        Assertions.assertEquals(700.0, account.getBalance(), 0.001);
    ...
    void testWithdrawFail() {
        ...
        assertFalse(result);
        Assertions.assertEquals(1000.0, account.getBalance(), "Баланс не должен измениться");
